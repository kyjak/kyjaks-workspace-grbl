...
cprequire_test(["inline:com-chilipeppr-workspace-grbl-kyjak"], function(ws) {
    ...
    $('title').html("Kyjak's Grbl Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-grbl-kyjak", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-grbl-kyjak", // Make the id the same as the cpdefine id
        name: "Kyjak's Workspace / GRBL", // The descriptive name of your widget.
        desc: `This is a Kyjak's fork of workspace for ChiliPeppr's Hardware Fiddle. It is geared towards CNC machines using GRBL.`,
