# com-chilipeppr-workspace-grbl-kyjak
This is a Kyjak's fork of workspace for ChiliPeppr's Hardware Fiddle. It is geared towards CNC machines using GRBL.



## ChiliPeppr Kyjak's Workspace / GRBL
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-grbl-kyjak |
| Name                  | Kyjak's Workspace / GRBL |
| Description           | This is a Kyjak's fork of workspace for ChiliPeppr's Hardware Fiddle. It is geared towards CNC machines using GRBL. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/https://master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/mkrsjak/grbl |
| Github URL            | http://github.com/https:/ |
| Test URL              | https://preview.c9users.io/mkrsjak/grbl/workspace.html |
...
chilipeppr.load(
  ...
  function() {
    ...
    cprequire(
      ["inline:com-chilipeppr-workspace-grbl-kyjak"], // the id you gave your workspace
      function(myWorkspaceGrblKyjak) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Kyjak's Workspace / GRBL just got loaded.", myWorkspaceGrblKyjak);
        myWorkspaceGrblKyjak.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-grbl-kyjak"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Kyjak's Workspace / GRBL"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"This is a Kyjak's fork of workspace for ChiliPeppr's Hardware Fiddle. It is geared towards CNC machines using GRBL."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/https://master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/mkrsjak/grbl"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/https:/"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://grbl-mkrsjak.c9users.io/workspace.html"</td></tr><tr valign="top"><td>foreignSubscribe</td><td>object</td><td>Please see docs above.</td></tr><tr valign="top"><td>foreignPublish</td><td>object</td><td>Please see docs above.</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
